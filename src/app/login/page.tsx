...
export default function Login() {
  return (
   ...
   <section className="bg-gradient-to-t from-white via-white to-teal-200 h-full w-full text-center text-indigo-600 ">
       ...
       <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-indigo-800 dark:border-indigo-700">
         <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
           ...
           <form className=" space-y-4 md:space-y-6" action="#">
             ...
             <button type="submit" className="w-full  text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-light rounded-lg text-sm px-5 py-2.5 text-center  mb-2">الدخول</button>

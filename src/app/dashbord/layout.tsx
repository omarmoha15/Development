...
const Sidebar = ({ navItems }: Props) => {
  ...
  const defaultNavItems: NavItem[] = [
    {
      ...
      href: "/dashbord/document",
      icon: <HomeIcon className="w-6 h-6" />,
    },
    {
      label: "المستندات والمشاهد",
      href: "/dashbord/employeeInfo",
      icon: <UserGroupIcon className="w-6 h-6" />,
    },
    {
      label: "الاجازات",
      href: "/dashbord/employeeVec",
      icon: <FolderIcon className="w-6 h-6" />,
    },
    {
      label: "الحضور والغياب",
      href: "/dashbord/employeeAtt",
  ...
  return (
    <div className="absolute flex-grow flex flex-col inset-y-0 gap-y-6 overflow-y-auto bg-gray-900 px-6 ">
      ...
      <nav className="flex flex-1 flex-col rtl ">

...
const Emp_en = (props) => {
  ...
  const [tbounus, settbonus] = useState('')
  ...
  return (
    ...
    <div className="layout" auth={auth}>
      ...
      <div className="absolute wrapper d-flex flex-column min-vh-100 bg-light">
        ...
        <div style={{ boxSizing: 'border-box', fontSize: '14px', direction: 'ltr' }}>
          <div
            ...
            id="pdf"
          >
            <Image src={Backgroundimage} alt="Logo" style={{ width: '725px' }} />
            <div
              style={{
                boxSizing: 'border-box',
                width: '701px',
